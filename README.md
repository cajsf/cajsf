...
**데이터에서 서비스까지 만드는 AI 개발자 지망생**입니다.
크롤링으로 데이터를 모으고, DB를 설계하고, 모델을 학습시켜, 웹 서비스로 배포하는 전 과정을 직접 구현하는 것을 좋아합니다.

- 🎓 세종대학교 인공지능학과 (2021.03 ~ )
- 🌱 최근 관심사: 딥러닝 기반 실서비스, MLOps, 백엔드 설계
- 🏠 **포트폴리오: [cajsf.github.io](https://cajsf.github.io)**
...
<img src="https://github-readme-stats.vercel.app/api?username=cajsf&show_icons=true" height="165"> <img src="http://mazassumnida.wtf/api/v2/generate_badge?boj=rkdalstjd113" height="165">
